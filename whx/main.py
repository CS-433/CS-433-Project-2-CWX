...
def train():
    ...
    for epoch in range(max_epoch):
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            print(
                "Step {}/{},  loss:{:.2f}, dice_1:{:.3f}, dice_2:{:.3f}, F1score_1:{:.3f}, F1score_2:{:.3f}, spent time:{:.2f}s"
                .format(i + 1, len(train_loader), loss.item(), dice_1.item(), dice_2.item(), F1score_1.item(),
                        F1score_2.item(), consume_time), '\n')
